...
class Gasto(models.Model):
    ...
    categoria = models.CharField(db_column='Categoria', max_length=100, db_collation='Modern_Spanish_CI_AS')  # Field name made lowercase.
...
class Logro(models.Model):
    ...
    condicion = models.CharField(db_column='Condicion', max_length=255, db_collation='Modern_Spanish_CI_AS')  # Field name made lowercase.
    usuarioid = models.ForeignKey('Usuario', models.DO_NOTHING, db_column='UsuarioId')  # Field name made lowercase.
...
class Metodologia(models.Model):
    id = models.AutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    descripcion = models.CharField(db_column='Descripcion', max_length=255, db_collation='Modern_Spanish_CI_AS')  # Field name made lowercase.
    usuarioid = models.ForeignKey('Usuario', models.DO_NOTHING, db_column='UsuarioId')  # Field name made lowercase.
...
class Usuario(models.Model):
    id = models.AutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    nombrecompleto = models.CharField(db_column='NombreCompleto', max_length=100, db_collation='Modern_Spanish_CI_AS')  # Field name made lowercase.
    correo = models.CharField(db_column='Correo', unique=True, max_length=100, db_collation='Modern_Spanish_CI_AS')  # Field name made lowercase.
    contraseniaencriptada = models.CharField(db_column='ContraseniaEncriptada', max_length=255, db_collation='Modern_Spanish_CI_AS')  # Field name made lowercase.
